...
| Warehouse | david@shop.com | Warehouse1234 |
      ...
      schemas: {
        ...
        Product: {
          ...
          properties: {
            ...
            barcode:     { type: 'string', example: '5012345001234', nullable: true },
            description: { type: 'string', nullable: true },
        ...
        InventoryItem: {
          ...
          properties: {
            ...
            stockValue:   { type: 'number', example: 399.50 },
        ...
        StockMovement: {
          ...
          properties: {
            ...
            type: {
              type: 'string',
              enum: ['purchase','sale','adjustment_in',
        ...
        SalesOrder: {
          ...
          properties: {
            ...
            type:         { type: 'string', enum: ['retail','wholesale'] },
            status:       { type: 'string', enum: ['completed','returned','partial_return'] },
    ...
    tags: [
      ...
      { name: 'Reports',    description: 'Analytics and reporting (admin/manager)' },
